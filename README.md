...
- Create a "times2" route that takes an argument in the URL and returns a respma create
Create a Cup model/schema with name, material, and manufacturerDate attributes. Create 3 entries using 3 different methods (admin site, create method using an endpoint, and class consonse with "The product times 2 is: [ANSWER]"
...
<hr>
1.5 points. Didn't create another new endpoint to change the material text of cups manufactured after 2012 to be "Slightly New"